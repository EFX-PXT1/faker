...
type Dowser interface {
	TitleMale(v reflect.Value, ctx *Context) (interface{}, error)
	TitleFeMale(v reflect.Value, ctx *Context) (interface{}, error)
	FirstName(v reflect.Value, ctx *Context) (interface{}, error)
	FirstNameMale(v reflect.Value, ctx *Context) (interface{}, error)
	FirstNameFemale(v reflect.Value, ctx *Context) (interface{}, error)
	LastName(v reflect.Value, ctx *Context) (interface{}, error)
	Name(v reflect.Value, ctx *Context) (interface{}, error)
}
...
func (p Person) TitleMale(v reflect.Value, ctx *Context) (interface{}, error) {
...
func (p Person) TitleFeMale(v reflect.Value, ctx *Context) (interface{}, error) {
...
func (p Person) FirstName(v reflect.Value, ctx *Context) (interface{}, error) {
...
func (p Person) FirstNameMale(v reflect.Value, ctx *Context) (interface{}, error) {
...
func (p Person) FirstNameFemale(v reflect.Value, ctx *Context) (interface{}, error) {
...
func (p Person) LastName(v reflect.Value, ctx *Context) (interface{}, error) {
...
func (p Person) Name(v reflect.Value, ctx *Context) (interface{}, error) {
	return p.name(), nil
}
