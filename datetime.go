...
type DateTimer interface {
	UnixTime(v reflect.Value, sf *reflect.StructField) (interface{}, error)
	Date(v reflect.Value, sf *reflect.StructField) (interface{}, error)
	Time(v reflect.Value, sf *reflect.StructField) (interface{}, error)
	MonthName(v reflect.Value, sf *reflect.StructField) (interface{}, error)
	Year(v reflect.Value, sf *reflect.StructField) (interface{}, error)
	DayOfWeek(v reflect.Value, sf *reflect.StructField) (interface{}, error)
	DayOfMonth(v reflect.Value, sf *reflect.StructField) (interface{}, error)
	Timestamp(v reflect.Value, sf *reflect.StructField) (interface{}, error)
	Century(v reflect.Value, sf *reflect.StructField) (interface{}, error)
	TimeZone(v reflect.Value, sf *reflect.StructField) (interface{}, error)
	TimePeriod(v reflect.Value, sf *reflect.StructField) (interface{}, error)
}
...
func (d DateTime) UnixTime(v reflect.Value, sf *reflect.StructField) (interface{}, error) {
	kind := v.Kind()
	var val int64
...
func (d DateTime) Date(v reflect.Value, sf *reflect.StructField) (interface{}, error) {
	return d.date(), nil
}
...
func (d DateTime) Time(v reflect.Value, sf *reflect.StructField) (interface{}, error) {
	return d.time(), nil
}
...
func (d DateTime) MonthName(v reflect.Value, sf *reflect.StructField) (interface{}, error) {
...
func (d DateTime) Year(v reflect.Value, sf *reflect.StructField) (interface{}, error) {
	return d.year(), nil
}
...
func (d DateTime) DayOfWeek(v reflect.Value, sf *reflect.StructField) (interface{}, error) {
...
func (d DateTime) DayOfMonth(v reflect.Value, sf *reflect.StructField) (interface{}, error) {
...
func (d DateTime) Timestamp(v reflect.Value, sf *reflect.StructField) (interface{}, error) {
...
func (d DateTime) Century(v reflect.Value, sf *reflect.StructField) (interface{}, error) {
...
func (d DateTime) TimeZone(v reflect.Value, sf *reflect.StructField) (interface{}, error) {
...
func (d DateTime) TimePeriod(v reflect.Value, sf *reflect.StructField) (interface{}, error) {
	return d.period(), nil
}
