...
type Money interface {
	Currency(v reflect.Value, ctx *Context) (interface{}, error)
	Amount(v reflect.Value, ctx *Context) (interface{}, error)
	AmountWithCurrency(v reflect.Value, ctx *Context) (interface{}, error)
}
...
func (p Price) Currency(v reflect.Value, ctx *Context) (interface{}, error) {
...
func (p Price) Amount(v reflect.Value, ctx *Context) (interface{}, error) {
	kind := v.Kind()
	val := p.amount()
...
func (p Price) AmountWithCurrency(v reflect.Value, ctx *Context) (interface{}, error) {
