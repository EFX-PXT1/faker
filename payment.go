...
type Render interface {
	CreditCardType(v reflect.Value, sf *reflect.StructField) (interface{}, error)
	CreditCardNumber(v reflect.Value, sf *reflect.StructField) (interface{}, error)
}
...
func (p Payment) CreditCardType(v reflect.Value, sf *reflect.StructField) (interface{}, error) {
	return p.cctype(), nil
}
...
func (p Payment) CreditCardNumber(v reflect.Value, sf *reflect.StructField) (interface{}, error) {
