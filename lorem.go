...
type DataFaker interface {
	Word(v reflect.Value, ctx *Context) (interface{}, error)
	Sentence(v reflect.Value, ctx *Context) (interface{}, error)
	Paragraph(v reflect.Value, ctx *Context) (interface{}, error)
}
...
func (l Lorem) Word(v reflect.Value, ctx *Context) (interface{}, error) {
	return l.word(), nil
}
...
func (l Lorem) Sentence(v reflect.Value, ctx *Context) (interface{}, error) {
	sentence := l.sentence()
	return sentence, nil
}
...
func (l Lorem) Paragraph(v reflect.Value, ctx *Context) (interface{}, error) {
